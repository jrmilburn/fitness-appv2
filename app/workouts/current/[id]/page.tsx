...
export default function Workout({ params }) {
    ...
    useEffect(() => {
        router.refresh();
        fetch(`${process.env.NEXT_PUBLIC_BASE_URL!}/api/workouts/current/${id}`, {
            method: 'GET',
            headers: {
    ...
    if (noWorkout) {
        return (
            <div className='mx-auto my-auto flex flex-col items-center space-y-16 h-screen w-full p-8 h-100% pb-20'>
    ...
    return (
        <div className='mx-auto flex flex-col items-center w-full sm:p-8 h-100% pb-20'>
